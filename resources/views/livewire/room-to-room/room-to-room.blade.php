<div>
    ...
    <h2 class="mt-10 text-lg font-medium">Room Campaign Management</h2>
    <div class="mt-5 grid grid-cols-12 gap-6">
        ...
        <!-- Add New Room Campaign Modal -->
        <x-menu.modal 
            :showButton="false" 
            modalId="add-campaign-modal" 
            title="Add New Room Campaign" 
            description="Fill in the details to add new room campaign"
            size="lg"
            ...
            <form wire:submit.prevent="createCampaign" class="space-y-4">
                <div class="grid gap-4 gap-y-3">
                    <div class="grid grid-cols-4 items-center gap-4">
                        <label class="text-right text-sm font-medium" for="add-room-name">
                            Room Name
                        </label>
                        <input 
                    ...
                    @error('room_name') <div class="col-start-2 col-span-3 text-danger text-xs">{{ $message }}</div> @enderror
        ...
        <x-menu.modal 
            ...
            <form wire:submit.prevent="updateCampaign" class="space-y-4">
                <div class="grid gap-4 gap-y-3">
                    <div class="grid grid-cols-4 items-center gap-4">
                        <label class="text-right text-sm font-medium" for="edit-room-name">
                            Room Name
                        </label>
                        <input 
                            wire:model.defer="room_name" 
                    ...
                    <tbody class="[&amp;_tr:last-child]:border-0">
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-8 text-gray-500">
                                No room campaigns found. Be the first to add a room campaign!
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
    ...
    <!-- Delete Room Campaign Modal -->
    @if($showDeleteCampaignModal)
    <x-menu.modal 
        :showButton="false" 
        modalId="delete-campaign-modal" 
        title="Delete Room Campaign" 
        ...
        <div class="text-center py-2">
            ...
            <div class="mt-2 text-sm">Are you sure you want to delete this room campaign?</div>
        </div>
        <x-slot:footer>
            <button data-tw-dismiss="modal" type="button" wire:click="$set('showDeleteCampaignModal', false)" class="cursor-pointer inline-flex border items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 text-foreground hover:bg-foreground/5 bg-background border-foreground/20 h-10 px-4 py-2 mr-1 w-24">
                Cancel
            </button>
            <button type="button" wire:click="deleteCampaign" class="cursor-pointer inline-flex border items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 bg-(--color)/20 border-(--color)/60 text-(--color) hover:bg-(--color)/5 [--color:var(--color-danger)] h-10 px-4 py-2 w-32">
                Delete
            </button>
        </x-slot:footer>
    </x-menu.modal>
